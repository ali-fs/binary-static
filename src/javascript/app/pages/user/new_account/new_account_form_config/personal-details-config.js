...
const personalDetailsConfig = ({ real_account_signup_target, residence_list, account_settings }) => {
    const [config, disabled_items] = getPersonalDetailsConfig({ residence_list, account_settings });
    return {
