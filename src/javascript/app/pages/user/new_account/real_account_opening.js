...
const RealAccountOpening = (() => {
    ...
    const onLoad = async () => {
        ...
        const [residence_list_response, account_settings_response, financial_assessment_response] = await Promise.all([residence_list_promise, account_settings_promise, financial_assessment_promise])
        ...
        steps = getSteps({ real_account_signup_target, residence_list, account_settings, upgrade_info, financial_assessment })
