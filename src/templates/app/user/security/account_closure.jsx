                ...
                <div className='gr-no-gutter'>
                    <div id='closing_steps' className='gr-padding-10'>
                        <div className='gr-padding-10'>
                            ...
                            <p className='no-margin'>{it.L('If you have a Deriv real account, go to [_1]Portfolio[_2] to close any open positions.', `<a href="${it.url_for('user/portfoliows')}">`, '</a>')}</p>
                        ...
                        <div className='gr-padding-30'>
                            ...
                            <p className='no-margin'>{it.L('If you have a Deriv real account, go to [_1]Cashier[_2] to withdraw your funds', `<a href="${it.url_for('cashier')}">`, '</a>')}</p>
